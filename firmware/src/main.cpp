...
// WiFi
const char *ssid = "Wokwi-GUEST";  // For Wokwi simulation (no password needed)
const char *password = "";

// ─── MQTT — Replace with your own HiveMQ Cloud credentials ───────────────────
...
const char *topic_prefix = "agribrain";  // Change to your own prefix
